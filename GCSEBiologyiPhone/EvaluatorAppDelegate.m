...
static NSString* const kAnalyticsAccountId = @"UA-40193785-1";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	NSString *difficulty =(NSString *)@"Core";
	...
	//User Access Level. 
	// Note : 1 = 30 Questions (Free) , 2 = 250 Questions, 3 = 500 Questions, 4 = 750 Questions, 5 = 1008 Questions
    ...
    if (![[GANTracker sharedTracker] trackEvent:@"Biology iPhone Started"
                                         action:@"Launch iOS"
                                          label:@"Launch iOS"
                                          value:1
                                      withError:&error]) {
...
-(BOOL)CopyDataBase{
    ...
    DevicePath = [documentsDir stringByAppendingPathComponent:@"iosBiology.sqlite"];
    ...
    BundlePath = [[NSBundle mainBundle] pathForResource:@"iosBiology" ofType:@"sqlite"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"iosBiology.sqlite"]];
