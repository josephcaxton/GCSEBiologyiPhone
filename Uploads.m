...
- (void)actionSheet:(UIActionSheet *)actionSheet willDismissWithButtonIndex:(NSInteger)buttonIndex{
		...
		if (buttonIndex != [actionSheet cancelButtonIndex]) {
			...
			NSString *Topicsresult = [TopicsdocumentsDirectory stringByAppendingString:@"/iosBiologyTopics.xml"];
			...
			[self DeleteFile:Topicsresult];	
				...
				NSString *Templateresult = [TemplatedocumentsDirectory stringByAppendingString:@"/iosBiologyTemplate.xml"];
				...
				NSString *Dataresult = [DataDirectory stringByAppendingString:@"/iosBiologyData.xml"];
