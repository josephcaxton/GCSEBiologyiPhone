...
-(IBAction)ShareThisAppViaMail:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
        ...
        [SendMailcontroller setSubject:@"Learn, revise and test yourself on the go - GCSE Biology App"];
...
-(void)ConnectToFaceBook {
    ...
    facebook = [[Facebook alloc] initWithAppId:@"440629832690594" andDelegate:self];
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                  @"I’ve just started using a new GCSE Biology App! Thousands of test questions and answers, plus you can record how well you do and share it. You should check it out, just search LearnersCloud in your device’s App store.",  @"message",nil];
...
-(void)Twit {
    ...
    {
        NSString *UrlString = @"https://itunes.apple.com/us/app/1.0/id638680582?ls=1&mt=8";
        
        TWTweetComposeViewController *tweetSheet = [[TWTweetComposeViewController alloc] init];
        [tweetSheet setInitialText:@"Checkout @LearnersCloud GCSE #Biology App - Learn, revise and test yourself on the go"];
